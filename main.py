...
async def post_sorting_data(
    url: str = "http://0.0.0.0:8080/api/v1/comments",
    sorting_parameter: str = "polarity",
    subfeddit_id: int = 0,
    skip: int = 0,
    limit: int = 25,
    start_time: int = 0,
    ...
    final_response = comment_sorting(
        url, sorting_parameter, subfeddit_id, skip, limit, start_time, end_time
    )
    return final_response
